...
def cooling_schedule_linear(current_temp, iteration, max_iterations):
    """
    Implements a linear cooling schedule.
    ...
    Returns:
        The new temperature
    """
    return current_temp - (current_temp / max_iterations) * iteration

def cooling_schedule_exponential(current_temp, iteration, max_iterations):
    """
    Implements an exponential cooling schedule.
    ...
    Returns:
        The new temperature
    """
    return current_temp * (0.99 ** (iteration / max_iterations))
