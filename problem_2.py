...
populationSize = 100 #size of GA population
Generations = 1000   #number of GA generations

crossOverRate = 0.9  #currently not used in the implementation; neeeds to be used.
mutationRate = 0.1  #currently not used in the implementation; neeeds to be used.
eliteSolutions = int(populationSize/10)  #currently not used in the implementation; neeed to use some type of elitism
